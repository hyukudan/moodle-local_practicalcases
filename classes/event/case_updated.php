...
/**
 * Event triggered when a case is updated.
 *
...
class case_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcaseupdated', 'local_casospracticos');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the practical case with id '$this->objectid'.";
    }
